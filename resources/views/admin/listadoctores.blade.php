        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Lista de Doctores</li>
                        ...
                        <div class="box">
                            <div class="box-header">
                                ...
                                <div class="row" style="margin: 16px 16px 0px 16px;" id="filter-row">
                                    <a href="/agregardoctor" style="margin-right: 20px;" class="btn btn-primary pull-right"></i>Agregar Doctor</a>
                                </div>
                                <div class="box-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            @php $i=1;@endphp
                                            @forelse($doctores as $doctor) <tr>
                                                <th>{{$i++}}</th>
                                                <td>{{$doctor->nombre." ".$doctor->apPaterno." ".$doctor->apMaterno}}</td>
                                                <td>{{$doctor->idEspecialidad}}</td>
                                                <th>{{$doctor->idUbicacion}}</th>
                                                <td>
